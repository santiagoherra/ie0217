...
MainFrame::MainFrame(const wxString& title) : wxFrame(nullptr, wxID_ANY, title) {
    ...
    wxGauge* gauge = new wxGauge(panel, wxID_ANY, 100, wxPoint(590, 205), wxSize(100, 125), wxGA_VERTICAL);
    gauge->SetValue(50);
    ...
    wxRadioBox* radioBox = new wxRadioBox(panel, wxID_ANY, "RadioBox", wxPoint(555, 475), wxDefaultSize, choices, 3, wxRA_SPECIFY_ROWS);
}
